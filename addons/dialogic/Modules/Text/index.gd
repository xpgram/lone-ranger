...
func _get_text_effects() -> Array[Dictionary]:
	return [
		...
		{'command':'p5', 'subsystem':'Text', 'method':'effect_pause_fifth', 'arg':false},
		{'command':'p5.', 'subsystem':'Text', 'method':'effect_pause_fifth_dot', 'arg':false},
		{'command':'p6', 'subsystem':'Text', 'method':'effect_pause_sixth', 'arg':false},
		{'command':'p6.', 'subsystem':'Text', 'method':'effect_pause_sixth_dot', 'arg':false},
